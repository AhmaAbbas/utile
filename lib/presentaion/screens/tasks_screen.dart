        ...
        builder: (context,state){
          if (state is Todo_Loadingdata)
          {
            ...
            return ListView.builder(
                itemCount:todocubit.newtasks.length,
                  ...
                  return Card(
                    child: ListTile(
                      leading:CircleAvatar(
                          radius: 40,
                          child: Text(todocubit.newtasks[index]["title"],
                            style:Styels.textStyle25.copyWith(
                              fontSize: 15
                            ),)) ,
                      title:Text(todocubit.newtasks[index]["date"]) ,
                      subtitle: Text(todocubit.newtasks[index]["status"]),
                      trailing: Text(todocubit.newtasks[index]["time"]),
                    ),
                  );
                });
          }
